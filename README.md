...
https://github.com/user-attachments/assets/65a800a2-7747-47ea-905c-6f460639e770
...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/jSPQgrSQv9)
...
```sh
npx nx serve flashcard
```

To create a production bundle:

```sh
npx nx build flashcard
```

To see all available targets to run for a project, run:

```sh
npx nx show project flashcard
```
...
- [Integrate a New Tool into an Nx Repository with a Tooling Plugin](https://nx.dev/extending-nx/tutorials/tooling-plugin#list-your-nx-plugin)
